...
export default function Home() {
  return (
    <div className="flex flex-col min-h-dvh">
      ...
      {/* ── Two-panel layout ───────────────────────────────────
          Mobile:  stacked (hero compact on top, games below)
          Desktop: hero stays sticky on the left while the game
                   grid scrolls on the right — both visible on
                   first load, no scroll required to find games. */}
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        >
          ...
          {/* Atmospheric orange bloom behind "ZONE" */}
          <div
            aria-hidden
          ...
          {/* ── Wordmark ────────────────────────────────────── */}
          {/* Sized to fill the 44vw panel: 4 Teko chars × 0.5em  */}
          {/* ≈ 2em wide, so font-size ≈ panel_usable_width / 2.  */}
          {/* clamp keeps it readable on mobile and capped on wide. */}
          ...
          <div className="hero-line hero-line-3 relative z-10 flex flex-col gap-3 mt-auto">
            ...
            >
              {/* On desktop the right panel makes scrolling obvious — */}
              {/* on mobile keep the CTA to guide users down.           */}
        ...
        {/* ── RIGHT: Game grid ─────────────────────────────── */}
        {/* flex-1 takes the remaining 56% on desktop.          */}
        {/* On mobile it's full-width below the hero section.   */}
        <main
          id="games"
      ...
      {/* Footer — appears after scrolling through all games */}
      <footer
